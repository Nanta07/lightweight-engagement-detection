...
def draw_sidebar(panel, pred, conf, fps):
    ...
    cv2.putText(panel, "Model : LOGREG", (15, 350),
                FONT, 0.6, (200, 200, 200), 1)
...
cv2.namedWindow("Engagement Detection - LOGREG", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Engagement Detection - LOGREG", 1000, 600)
...
while True:
    ...
    _, _, win_w, win_h = cv2.getWindowImageRect("Engagement Detection - LOGREG")
    ...
    cv2.imshow("Engagement Detection - LOGREG", ui)
